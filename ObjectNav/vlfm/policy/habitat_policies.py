...
MP3D_ID_TO_NAME = [
    ...
    "couch",  # "sofa",
    "bed",
    "bedside cabinet",  # "chest of drawers"
    "potted plant",  # "plant",
    "sink",
    "toilet",
    "stool",
...
class HabitatMixin:
    ...
    def _cache_observations(self: Union["HabitatMixin", BaseObjectNavPolicy], observations: TensorDict) -> None:
        ...
        self._observations_cache = {
            ...
            "robot_xy": robot_xy,
            "habitat_position": np.array([x, self._camera_height, y]), # Original habitat coordinate system
            "camera_position": camera_position, # Common xyz coordinate system
