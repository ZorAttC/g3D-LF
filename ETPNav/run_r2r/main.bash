...
case $mode in 
      train)
      echo "###### train mode ######"
      CUDA_VISIBLE_DEVICES='0,1' python3 -m torch.distributed.launch --nproc_per_node=2 --master_port $2 --use_env run.py $flag1
      ;;
      eval)
      echo "###### eval mode ######"
      CUDA_VISIBLE_DEVICES='2' python3 -m torch.distributed.launch --nproc_per_node=1 --master_port $2 --use_env run.py $flag2
      ;;
      infer)
      echo "###### infer mode ######"
